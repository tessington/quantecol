killer_whale_extinction <-function(model.type="base") {
  ...
  #' @examples
  #' # View the code
  #' print(killer_whale_extinction)
  #' # Run the base model
  #' extinct.base <- killer_whale_extinction(model.type = "base")
  #' # create the uncertainty model
  #' extinct.uncertainty <- killer_whale_extinction(model.type = "uncertainty")
